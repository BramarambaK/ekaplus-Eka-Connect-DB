db.getCollection('boliden_Meta').remove({"type":"policy","refTypeName": "supplierconnect"});//
db.getCollection('boliden_Meta').remove({"type":"app","name": "supplierconnect"});//
db.getCollection('boliden_Meta').remove({"type": "object","name": "User_Info"});//
db.getCollection('boliden_Meta').remove({"type": "object","name": "supplier"});//
db.getCollection('boliden_Meta').remove({"type": "object","name": "deliveryitem"});//
db.getCollection('boliden_Meta').remove({"type":"message"});//
db.getCollection('boliden_Meta').remove({"type":"workflow","app": "supplierconnect"});//
db.getCollection('boliden_Meta').remove({"type":"object","name": "Gmr_Basic"});//
db.getCollection('boliden_Meta').remove({"type":"object","name": "Assaying"});//
db.getCollection('boliden_Meta').remove({"type":"object","name": "Packaging"});//
db.getCollection('boliden_Meta').remove({"type":"object","name": "Recommendation"});//

db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_ctrm_host"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_utility_host"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_platform_host"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_auth_server_host"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_redis_host"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_redis_port"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_mdm_isCacheEnabled"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_connect_host"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_mdm_host"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_auth_url"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_auth_validate_url"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_connect_ui_host"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "platform_url"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "nifi_host"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "nifi_port"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "nifi_endPointVsNifiPort"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_logout_url"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_invalidate_session_url"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "spring_redis_port"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "spring_redis_host"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "spring_profiles_active"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "delivery_items_url"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "gmr_create_url"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_connect_mongo_uri"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "mongo_container_name"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "mongo_port"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "mongo_database"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "mongo_username"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "mongo_password"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "spring_data_mongodb_uri"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_UserAuthentication_url"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "eka_validateToken_url"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "contract_details_url"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "assay_url"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "stock_url"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "date_picker_format"});//
db.getCollection('boliden_Meta').remove({"type": "property","name": "month_picker_format"});//
                        ...
                        "menuItems" : [ 
                            {
                                ...
                                "items" : [ 
                                    {
                                        "handler" : "/app/supplierconnect/deliveryItemlisting/list",
                                        "text" : "Contract Items Open for Advice",
                                        "iconCls" : ""
                                    }, 
                                    {
                                        "handler" : "/app/supplierconnect/supplierlisting/list",
                                        "text" : "Deliveries",
                                        "iconCls" : ""
                                    }
                                ]
...
db.getCollection('boliden_Meta').insert({
    ...
    "fields" : {
        ...
        "Adviced Weight" : {
            "Adviced Weight" : "Adviced Weight",
            "labelKey" : "Adviced Weight"
        },
        "Weight Unit" : {
        ...
        "Container Size(s)" : {
            "Container Size(s)" : "Container Size(s)",
            "labelKey" : "Container Size(s)"
        },
        "No of Containers" : {
            "No of Containers" : "No of Containers",
            "labelKey" : "No of Containers"
        },
        "Smelter" : {
            "Smelter" : "Smelter",
            "labelKey" : "Smelter"
		...
		"Earliest Price Fixation" : {
            "Earliest Price Fixation" : "Earliest Price Fixation",
            "labelKey" : "Earliest Price Fixation"
        },
		"EnrichmentErrorStatus" : {
            "EnrichmentErrorStatus" : "EnrichmentErrorStatus",
            "labelKey" : "EnrichmentErrorStatus"
        },
		"Use Boliden Assay" : {
            "Use Boliden Assay" : "Use Boliden Assay",
            "labelKey" : "Use Boliden Assay"
        },
		"Final Assay Confirmed" : {
            "Final Assay Confirmed" : "Final Assay Confirmed",
            "labelKey" : "Final Assay Confirmed"
        },
		"Automatic Pricing" : {
            "Automatic Pricing" : "Automatic Pricing",
            "labelKey" : "Automatic Pricing"
        },
		"Moisture" : {
            "Moisture" : "Moisture",
            "labelKey" : "Moisture"
		...
		"Transport ID" : {
            ...
            "labelKey" : "Transport ID"
        },
		"AssayDueDate" : {
            "AssayDueDate" : "AssayDueDate",
            "labelKey" : "AssayDueDate"
        },
        "Created By" : {
...
db.getCollection('boliden_Meta').insert({
    ...
    "flow" : {
        ...
        "supplierlisting" : {
            ...
            "apiInfo" : {
                "host" : "https://boliden.ekaplus.com",
            ...
            "fields" : [ 
                ...
                {
                    "key" : "Container Size(s)",
                    "label" : "Container Size(s)",
                    "sort" : true,
                    "filter" : true,
                    "edit" : false
                }, 
                {
                    "key" : "No of Containers",
				...
				{
                    "key" : "EnrichmentErrorStatus",
                    "label" : "EnrichmentErrorStatus",
                    "sort" : true,
                    "filter" : true,
                    "edit" : false
                }, 
				{
                    "key" : "Use Boliden Assay",
                    "label" : "Use Boliden Assay",
                    "sort" : true,
                    "filter" : true,
                    "edit" : false
                }, 
				{
                    "key" : "Final Assay Confirmed",
                    "label" : "Final Assay Confirmed",
                    "sort" : true,
                    "filter" : true,
                    "edit" : false
                }, 
        ...
        "assayinglisting" : {
            ...
            "objectAction" : "UPDATE",
            "getDataFromExternalAPI" : true,
			"url" : "http://172.31.254.21:3333/collection/assayList",
            "layout" : {
                "name" : "assay",
                "selection" : "row",
                "header" : {
        ...
        "viewgmrbasic" : {
            ...
            "objectAction" : "READ",
			 "url" : {
                "connectApi" : "http://172.31.254.21:3333/collection/assayAndStockList",
                "ctrmApi" : "http://10.161.65.88:7001/api/logistic/viewGmr"
            }, 
            "layout" : {
                "name" : "gmr",
				"key" : "GMR No"
...
db.getCollection('boliden_Meta').insert({
    ...
    "name" : "en-US",
    "locale" : "en-US",
	"mandatoryField" : "{0} is mandatory field",
...
db.getCollection('boliden_Meta').insert({
    ...
    "fields" : {
		...
		"executedQty" : {
            "executedQty" : "Executable Qty",
            "labelKey" : "executedQty",
            "dataType" : "String"
        },
        "executableQty" : {
            "executableQty" : "Executable Qty",
            "labelKey" : "executableQty",
            "dataType" : "String"
        },
        "fromDate" : {
            "fromDate" : "From Date",
        ...
        "delLocation" : {
            ...
            "labelKey" : "delLocation",
            "dataType" : "String"
        },
        "cpName" : {
            "cpName" : "Supplier Name",
            "labelKey" : "cpName",
            "dataType" : "String"
        }
    },
...
db.getCollection('boliden_Meta').insert({
	"type" : "property",
    "name" : "eka_invalidate_session_url",
    "propertyLevel" : "app",
    "dataType" : "String",
    "fieldtype" : "textbox",
    "length" : "120"
...
db.getCollection('boliden_Meta').insert({
	"type" : "property",
    "name" : "eka_UserAuthentication_url",
    "propertyLevel" : "tenant,app,user",
    "dataType" : "String",
    "fieldtype" : "textbox",
    "length" : "150"
