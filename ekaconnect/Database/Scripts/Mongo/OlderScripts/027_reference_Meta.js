...
<<<<<<< HEAD
=======
>>>>>>> 319a883c... Create 027_reference_Meta.js
...
=======
            ...
            {
                "name" : "List",
                "url" : "/app/hello/hello/listing/view",
                "icon" : "icon-speedometer",
                "badge" : {
                    "variant" : "info",
                    "text" : ""
...
=======
    {
    "refTypeName" : "hello",
    "name" : "helloWorldPolicy",
    "refType" : "app",
    "tenantId" : "",
    "hello" : {
        "5caf1788045f030620117dd5" : {
            "userGrants" : {
                "2266" : {
>>>>>>> development
=======
...
db.getCollection('reference_Meta').insert({
    {
    "_id" : ObjectId("5caf0e8e8fde8fc2cce1e41b"),
    "name" : "hello",
    "label" : "Hello World",
    "type" : "object",
    "tenantID" : "",
...
>>>>>>> 319a883c... Create 027_reference_Meta.js
        ...
        "deliveryItemlisting" : {
            ...
            "label" : "Contract Delivery Item List",
            "object" : "deliveryitem",
            "objectAction" : "READ",
            "apiInfo" : {
...
>>>>>>> 319a883c... Create 027_reference_Meta.js
        ...
        "attributedetails" : {
            ...
            "layout" : {
                ...
                "data" : {
                    "url" : "http://192.168.1.169:6001/api/logistic/contract",
                    "headers" : {
                        "username" : "e-bolprpa"
                    }
                }
...
>>>>>>> 319a883c... Create 027_reference_Meta.js
        ...
        "_EXT_CREATE_GMR" : {
            ...
            "apiInfo" : {
                "host" : "http://172.16.5.101:3333",
                "path" : "/collection/supplierconnect/Gmr_Basic/createGmr",
                "method" : "POST",
                "body" : {},
...
db.getCollection('reference_Meta').remove({"type":"policy","refTypeName" : "hello"});//
db.getCollection('reference_Meta').remove({"type":"app","name": "hello"});//
db.getCollection('reference_Meta').remove({"type": "object","name": "hello"});//
db.getCollection('reference_Meta').remove({"type":"message"});//
db.getCollection('reference_Meta').remove({"type":"Workflow","app": "hello"});//
>>>>>>> development
=======
>>>>>>> 319a883c... Create 027_reference_Meta.js
