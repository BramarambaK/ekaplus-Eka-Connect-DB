                        ...
                        "menuItems" : [ 
                            {
                                ...
                                "items" : [ 
                                    {
                                        "handler" : "/app/supplierconnect/deliveryitem/deliveryItemlisting/view",
                                        "text" : "List of Contract Delivery Item",
                                        "iconCls" : ""
                                    },
									{
                                        "handler" : "/app/supplierconnect/supplier/supplierlisting/view",
                                        "text" : "List of GMR's",
                                        "iconCls" : ""
                                    }
                                ]
...
db.getCollection('reference_Meta').insert({
    ...
    "flow" : {
        ...
        "viewgmrbasic" : {
            ...
            "object" : "Gmr_Basic",
            "objectAction" : "READ",
			"url" : "http://192.168.1.169:6001/api/logistic/viewGmr",
            "layout" : {
                "name" : "gmr",
				"key" : "GMR Ref No"
            },
