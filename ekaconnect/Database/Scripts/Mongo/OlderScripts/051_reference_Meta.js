...
db.getCollection('reference_Meta').insert({
    ...
    "tenantId" : "reference",
	 "051755e6-c3a6-4310-8bf5-0cfa44a3b7a7" : {
        "globalGrants" : {
            "userGrants" : {},
            "roleGrants" : {
                "124" : {
...
db.getCollection('reference_Meta').insert({
    ...
    "flow" : {
		...
		"viewprofile" : {
            ...
            "label" : "User Profile",
            "object" : "051755e6-c3a6-4310-8bf5-0cfa44a3b7a7",
            "objectAction" : "READ",
            "layout" : {
                "name" : "viewprofile",
                "type" : "row",
...
db.getCollection('reference_Meta').insert({
    ...
    "description" : "View Registration in Supplier Connect",
    "label" : "View_Registration",
    "type" : "object",
    "sys__UUID" : "051755e6-c3a6-4310-8bf5-0cfa44a3b7a7",
    "objectAction" : {
        "CREATE" : "POST",
        "UPDATE" : "PUT",
        "READ" : "GET",
